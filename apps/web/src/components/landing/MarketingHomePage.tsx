      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: 'JackOps',
            description: 'JackOps — AI operations command center. Run, monitor, approve, secure, audit, and replay AI-agent workflows from one dashboard.',
          ...
          <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-4 sm:px-6 lg:px-8">
            ...
            */}
            <div className="flex items-center gap-2 shrink-0">
              <JakLogo size={32} />
              <span className="text-base sm:text-lg font-display font-bold tracking-tight whitespace-nowrap">JackOps</span>
            </div>
            ...
            <div className="grid gap-12 md:grid-cols-4">
              ...
              <div className="md:col-span-1">
                <div className="flex items-center gap-2 mb-4">
                  <JakLogo size={28} />
                  <span className="text-base font-display font-bold tracking-tight">JackOps</span>
                </div>
