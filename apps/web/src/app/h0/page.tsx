...
export const metadata: Metadata = {
  ...
  description:
    'JackOps is an AI operations command center for startups and SMEs. Run, monitor, approve, secure, audit, and replay AI-agent workflows from one dashboard. Vercel + Amazon Aurora PostgreSQL.',
  openGraph: {
    title: 'JackOps — AI Operations Command Center',
    description:
